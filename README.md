...
The cost function needed for the optimization algorithm is formed as mean squared error between the network’s prediction and the steering training data.
