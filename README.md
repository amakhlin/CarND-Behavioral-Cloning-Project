...
## Results
The model is capable of staying on the road in the first track even in the presence of perturbations. In the course of normal (non-perturbed) driving the car tracks smoothly and does not cross yellow lines or red zebra sections indicating turns.
