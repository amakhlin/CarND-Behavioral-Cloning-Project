...
run it as follows: `python model.py`
'''
...
def make_model_nvidia():
    ...
    "End to End Learning for Self-Driving Cars". This model has a shallower fully connected layer stack interspersed with dropout to mitigate
    the effects of over-fitting.  It takes in a smaller image size: 66x66. The paper can be downloaded here:
